...
public class InventoryManager : MonoBehaviour
{
    ...
    //public ModifierValues itemIsUsed(InventoryItem item)
    //{
    //    ModifierValues modifierValues = new ModifierValues();
    //    List<ModifierID> itemModifiers = item.GetItemModifiers(item.GetComponent<>);
    //    foreach (ModifierID itemModifier in itemModifiers)
    //    {
    //        return (ModifierValues)modifierValues.Value[itemModifier];
    //    }
    //    
    //
    //}
